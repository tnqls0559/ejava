...
public class Person {
	...
	static void print(Person p) {
		...
		else if(p instanceof Student) System.out.println("Student");
		else if(p instanceof Researcher) System.out.println("Researcher");
		else if(p instanceof Professor) System.out.println("Professor");
		System.out.println("---------------------------");
	}
}
